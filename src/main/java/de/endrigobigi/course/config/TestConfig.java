...
import de.endrigobigi.course.entities.Category;
import de.endrigobigi.course.entities.Order;
import de.endrigobigi.course.entities.OrderItem;
import de.endrigobigi.course.entities.Payment;
import de.endrigobigi.course.entities.Product;
import de.endrigobigi.course.entities.User;
import de.endrigobigi.course.entities.enums.OrderStatus;
import de.endrigobigi.course.repositories.CategoryRepository;
import de.endrigobigi.course.repositories.OrderItemRepository;
import de.endrigobigi.course.repositories.OrderRepository;
import de.endrigobigi.course.repositories.ProductRepository;
...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		o1.setPayment(pay1); //no caso de relações um-para-um o valor deve ser salvo na classe independente!
